    ...
    <div className="bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-lg p-4 my-2">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div>
          ...
          {/* TODO: Задание 13.2 — Отобразите изменение ELO после матча
           *
        ...
        <div>
          ...
          {/* TODO: Задание 13.2 — Отобразите K/D игрока
           *
        ...
        <div>
          ...
          {/* TODO: Задание 13.2 — Добавьте ссылку на страницу матча на FACEIT
           *
      ...
      {/* BONUS: Задание 13.2 — Дополнительные метрики
       *
